...
const List = () => {
    ...
    const { data, loading, error, refetch } = useApiService('/cms/menus');
    ...
    return (<div>
        ...
        <ButtonGroup>
            <Button to={`/cms/menus/create`} >Create New Menu</Button>
        </ButtonGroup>
                        ...
                        <td>
                            <div className="d-flex gap-2">
                                {deleteId !== item.id ? (<ButtonGroup>
                                    <Button label="View" to={`/cms/menus/${item.id}`} />
                                    <Button label="Delete" variant="danger" onClick={() => deleteMenu(item.id)} />
                                </ButtonGroup>)
                                    :
                                    <span>Deleting...</span>
                                }
